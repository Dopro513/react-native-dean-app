...
export default class SelectSkill extends Component {
  ...
  constructor() {
    ...
    this.state = {
      dataSource: ds.cloneWithRows(require('../components/skills.json')),
      db:require('../components/skills.json'),
      searchText: '',
      fontLoaded:false,
    };
  }
  ...
  next() {
    ...
    if(rows.length == 0) {
      ...
      //   index: 0,
      //   actions: [
      //     NavigationActions.navigate({ routeName: 'MainVC', params:{user}}),
      //   ],
      // })
      // this.props.navigation.dispatch(resetAction)
    }
        ...
        <View style={styles.container}>
            <View style={{alignItems: 'center', justifyContent: 'space-around', flex: 1,}}>
                <View style={styles.topbar}>
                    ...
                    {
                      this.state.fontLoaded?<Text style={{fontSize: 20, fontFamily:'AbrilFatface-Regular', color: 'rgb(74,74,74)', textAlign: 'center', flex:1,}}> Skills </Text>
                      :<Text style={{fontSize: 20, color: 'rgb(74,74,74)', textAlign: 'center', flex:1,}}> Skills </Text>
                    }
                    <View style={{width: 50}}/>
                </View>
